...
__decorate([
    ...
    (0, class_validator_1.IsInt)(),
    __metadata("design:type", Number)
], CreateScheduleDto.prototype, "gradeSubjectId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ enum: client_1.DayOfWeek }),
    (0, class_validator_1.IsEnum)(client_1.DayOfWeek, { message: 'يوم الأسبوع غير صالح' }),
    __metadata("design:type", String)
], CreateScheduleDto.prototype, "dayOfWeek", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: '08:00' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)({ message: 'وقت البداية مطلوب' }),
    __metadata("design:type", String)
], CreateScheduleDto.prototype, "startTime", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: '08:45' }),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)({ message: 'وقت النهاية مطلوب' }),
    __metadata("design:type", String)
], CreateScheduleDto.prototype, "endTime", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'قاعة 101' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CreateScheduleDto.prototype, "room", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ enum: client_1.ScheduleStatus }),
    (0, class_validator_1.IsOptional)(),
